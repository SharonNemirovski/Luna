    ...
    <div className="Contact DropAnimation">
      <div className="wrap">
        <div className="data">
          ...
          <label>להתקשר במטכ"לי למספר - 0303-3697 </label>
          <label>גל גלזר - 052-4447716</label>
          <label>ציון לביא - 052-4604154</label>

          <label>

            <h3>במידה וישנה בעיה טכנית במערכת, יש להתקשר למספרים הבאים:</h3>
          </label>
